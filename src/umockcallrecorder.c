    ...
    else
    {
        ...
        else
        {
            ...
            if (result != NULL)
            {
                ...
                /* Codes_SRS_UMOCKCALLRECORDER_01_085: [ `umockcallrecorder_clone` shall also copy the `lock_function`, `unlock_function` and lock `context` from `umock_call_recorder` to the cloned call recorder. ]*/
